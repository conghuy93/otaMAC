...
public:
    ...
    bool HasGitHubUpdate() { return has_github_update_; }
    const std::string& GetGitHubVersion() const { return github_version_; }
    const std::string& GetGitHubUrl() const { return github_url_; }
...
private:
    ...
    bool has_github_update_ = false;
    std::string github_version_;
